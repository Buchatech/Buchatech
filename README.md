...
<h4 align="left">Welcome to my GitHub profile. I am a startup advisor & engineering manager, delivering Azure & AKS cloud-native services powering Apple SaaS products used by over 70k customers worldwide ☁️. I work in the areas of AKS, anything Container related 🐋☸️, AI, and Linux. <br><br> I am a Microsoft MVP x11, Docker Captain x2, Pluralsight author x33, and the author of nine technical books. I have presented at many tech events, including DevOps Days, Open Source North, Midwest Management Summit (MMS), Microsoft Ignite, BITCon, Experts Live Europe, OSCON, Inside Azure management, and many user groups. I am currently focused on all things AI, cloud, Cloud Native, and GitOps. I stay active in the technical community and enjoy blogging about my adventures in the world of IT here www.buchatech.com</h4>
...
- 💬 Ask me about **Azure, GCP, AWS, Docker, Kubernetes, Argo CD, Terraform/OpenTofu, AI**
